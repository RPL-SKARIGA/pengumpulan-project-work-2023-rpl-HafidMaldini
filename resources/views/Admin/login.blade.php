              ...
              <div class="card bg-dark text-white" style="border-radius: 1rem;">
                <div class="card-body p-5 text-center">
                  ...
                  <div class="mb-md-5 mt-md-4 pb-5">
                    ...
                    <br>
                    <br>
                    <form method="POST" action="/prosesLoginAdmin">
                      @csrf
                    <div class="form-outline form-white mb-4">
                      <input  type="username" id="typeUsername" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="none">
                      <label class="form-label" for="typeUsername">{{ __('Username') }}</label>
                    </div>
