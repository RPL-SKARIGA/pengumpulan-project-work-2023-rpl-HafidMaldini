...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('history')}}" class="btn btn-outline" >Kembali</a>
        ...
        $(document).ready(function () {
            $('.edit-jawaban').click(function () {
                ...
                if(newJwb == '' || oldJwb != newJwb){
                    $('.jwb-'+id).html('<div id="edit-form"><input type="text" value="{{ $jwb->isiJawaban }}" name="newJwb" class="newJwb"><button id="simpan-edit" class="simpan-edit">Simpan</button><button class="batal-edit">Batal</button></div>');
                }else{
                ...
                $('.batal-edit').click(function () {
                    $('.jwb-'+id).html('<p>{{ $jwb->isiJawaban }}</p>');
                });
